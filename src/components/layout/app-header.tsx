        ...
        <Link href="/" className="flex items-center gap-2 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs text-muted-foreground truncate">
              Document visits with photos & notes
            </p>
          </div>
        </Link>
        <Link
          href="/visits/new"
          className="shrink-0 rounded-lg bg-teal-600 px-3 py-2 text-sm font-medium text-white hover:bg-teal-700 transition-colors"
        >
          Log visit
        </Link>
      </div>
